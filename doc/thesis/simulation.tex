...
Approaches to executing the type of real-time simulations are implemented in the \emph{cRealTimeScheduler}.
...
%TODO: find correct place for specs and add APC spec
