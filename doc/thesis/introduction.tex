...
Furthermore a simulation of the real-time communication protocol POWERLINK and its open source implementation openPOWERLINK \cite{openpowerlink} is implemented. %TODO: add ref to POWERLINK
